...
class OTTOAN_TD_CAU_HOI extends AbstractModel {
    ...
    public function getDataAll($search, $sort, $offset = null, $limit = null) {
        ...
        $fields = " DISTINCT
                    ...
                    slmon.slmon,
                    sltl.sltl";
        $where = " WHERE a.ottoan_td_cau_tra_loi_id IS NOT NULL AND c.ottoan_td_mon_hoc_id IS NOT NULL ";
//        $wheres = $this->makeWhereClause($search);
        $params = NULL;
//        if ($wheres) {
//            $where .= " AND " . $wheres['where'];
...
//        }
        ...
        return $this->load($fields, $table, "WHERE a.ottoan_td_cau_hoi_id = b.ottoan_td_cau_hoi_id 
	AND b.ottoan_td_mon_hoc_id = c.ottoan_td_mon_hoc_id
        AND sltl.ottoan_td_cau_hoi_id = b.ottoan_td_cau_hoi_id 
	AND slmon.ottoan_td_mon_hoc_id = c.ottoan_td_mon_hoc_id " , $params, $sort);
    }
